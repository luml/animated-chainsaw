...
const AddAppointment = ({onAddAppoinment, lastId}) => {
  ...
  function formDataPublish() {
    ...
    onAddAppoinment(appointmentInfo);
  ...
  return (
    <div>
      <button
        ...
        // Ternary expression for className
        className={`bg-blue-400 text-white px-2 py-3 w-full text-left rounded-t-md ${!toggleForm ? 'rounded-md' : 'rounded-t-md'} `}>
